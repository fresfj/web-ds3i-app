    ...
    return (
        ...
        <main className="main-wrapper">
            ...
            <LazyLoad height={200} offset={[-100, 0]} once >
                <BcrumbBannerOne 
                    title="As melhores soluções para o seu negócio"
                    paragraph ="Já tiramos centenas de ideias do papel e tivemos o prazer de trabalhar com dezenas de empresas."
                    styleClass=""
                ...
                <nav id="onepagenav" className="service-scroll-nav navbar onepagefixed">
                    <div className="container">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="#section2">Desenvolvimento</a>
                        </li>    
                        <li className="nav-item">
                            <a className="nav-link" href="#section1">Design</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="#section3">Marketing Digital</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="#section4">Business</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="#section5">Tecnologias</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="#section6">Estratégias</a>
                        </li>
                        </ul>
                    </div>
                </nav>
